...
<template>
    <userLayoutsNoNav>
        <div class="max-w-xl mx-auto mt-5 p-4 gap-[20px] flex flex-col font-prompt">
            <div class=" flex justify-between items-center ">
                <RouterLink to="/" class="bg-[#ffffff] flex w-[42px] h-[42px] items-center justify-center  rounded-full"
                    style="box-shadow: 0px 4px 12px 0px #0D0A2C0F;">
                ...
                <h2 class="text-[20px] leading-[28px] font-bold mx-auto">ประวัติการสั่งซื้อ</h2>
