...
const shops = [
    { name: "ร้านขนมหวานใจ", rate: 4.9, distance: 1.2 },
    { name: "ร้านก๋วยเตี๋ยวป้าศรี", rate: 4.9, distance: 2.2 },
    { name: "ร้านอาหารนานาชาติ", rate: 4.9, distance: 3.2 },
    { name: "ร้านคาเฟ่สบายใจ", rate: 4.9, distance: 3.4 },
    { name: "ร้านอาหารอีสานแซ่บ", rate: 4.9, distance: 4.2 },
    { name: "ร้านอาหารชาววัง", rate: 4.9, distance: 5.2 },
]
...
<template>
    ...
    <div class="flex flex-col items-center justify-center h-screen w-full ">
        ...
        <div class="absolute top-[232px] overflow-x-auto scrollbar-hide w-[300px] h-[40px]">
        ...
        <div class="absolute top-[284px] flex flex-col w-[300px] h-full rounded-t-xl overflow-hidden ">
            <div class="relative w-[288px] h-[px] flex pt-2 gap-y-3 rounded-xl buyfood" v-show="isVisible('buyfood')">
                ...
                <div class="flex flex-col w-[154px] h-[80px] gap-[8px]">
                    ...
                    <div class="flex items-center gap-2 justify-between">
                        ...
                        <RouterLink to="/orderlist/trackorder"
                            @click="() => console.log('Navigating to track order page')"
                            class="flex items-center h-[26px] gap-[2px] rounded-tl-[20px] border-t border-l border-[#E9EAEB]">
                            <span class="h-[18px] font-prompt text-[12px] leading-[18.14px] text-[#FF6347]">ชื้ออาหาร
                            </span>
                        </RouterLink>
                    </div>
                    <div class="rating">
            ...
            <div class="relative w-[288px] h-[96px] flex pt-2 gap-3 rounded-t-xl buyfood" v-show="isVisible('buyfood')">
                <div class="w-[80px] h-[80px]">
                    <PicSlideShow :images="images" :currentSlide="currentSlide" />
                </div>
                <div class="flex flex-col w-[154px] h-[80px] gap-[8px]">
