  ...
  <userLayoutsNoNav>
    ...
    <div v-else class="">
      ...
      <div v-if="authStore.isAuthenticated">
        ...
        <div class="flex justify-center sm:mt-4 mt-8 font-prompt">

          <div @click="confirmLogout" class="sm:h-[60px] sm:w-[450px] h-[54px] w-[340px] bg-[#FFEFED] rounded-full p-1 flex justify-center items-center mt-5 cursor-pointer hover:-translate-y-1 transition-all duration-500 group">
        ...
        <div>
          <RouterLink to="/businesscenter" v-if="restaurantsOwner"
            ...
            <div
              class="sm:h-[60px] sm:w-[450px] h-[60px] w-[340px] rounded-xl p-1 flex justify-center items-center mt-3"
