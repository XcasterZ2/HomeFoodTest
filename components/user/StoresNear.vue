...
<template>
    <div class="p-5">
        ...
        <div v-if="activeSection === 'open'" class="mt-3">
            <div v-if="isLoading" class="flex w-full justify-center mt-5">
            ...
            <div v-else v-for="shop in restaurants" :key="shop.name" @click="navigateToRestaurant(shop.restaurant_Id)">
                <div class="w-full sm:h-[140px] h-[70px] mt-2 flex">
                    ...
                    <div class="flex w-full item">
                        <div class="mx-4 flex flex-col">
                            <div>
                                <h2 class="text-base sm:text-lg">{{ shop.name }}</h2>
                            </div>
                            <div class="flex sm:mt-2">
                                <svg class="mt-1" width="14" height="14" viewBox="0 0 14 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h2 class="mx-1 text-[#8D92A3] text-base sm:text-lg">{{ shop.rate }} | </h2>
                                <h2 class="text-[#8D92A3] text-base sm:text-lg">{{ shop.distance }} m</h2>
                            </div>
                        </div>
                        ...
                        <div class="flex-1 flex item w-full justify-center sm:justify-end  sm:mx-10">
                            <div
                                ...
                                <h2 class="mx-1 text-[#6D6C69] text-base sm:text-">฿{{ shop.shopcost }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
