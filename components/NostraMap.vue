<template>
  <div>
    <div id="map" ref="mapContainer" class="sm:w-[700px] sm:h-[500px] w-[360px] h-[650px]"></div>
    <!-- <div class="absolute bottom-0 bg-white p-4 rounded-lg shadow-md z-10">
      <div class="mb-4 grid grid-cols-1 gap-2">
        <button v-for="(mapType, index) in mapTypes" :key="index" @click="switchMapType(mapType.name)"
      ...
      <div class="space-y-3">
        <div>
          ...
          <div class="flex items-center space-x-4">
            <label class="inline-flex items-center">
              <input type="radio" :value="true" v-model="isEnglish" @change="switchLanguage" class="mr-2">
              English
            </label>
            <label class="inline-flex items-center">
              <input type="radio" :value="false" v-model="isEnglish" @change="switchLanguage" class="mr-2">
              Local
            </label>
          </div>
        </div>
        ...
        <div>
          ...
          <select v-model="selectedCountry" @change="switchCountry" class="w-full px-2 py-1 border rounded">
