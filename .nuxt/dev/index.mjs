...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "googleClientId": "969597243905-31e2i7vkcp6co032dlsp1ev9s5l94v2n.apps.googleusercontent.com",
    "googleRedirectUri": "http://localhost:3000/api/auth/callback/google",
    "lineClientId": "2006579241",
    "lineRedirectUri": "http://localhost:3000/api/auth/callback/line"
  },
  "googleClientId": "969597243905-31e2i7vkcp6co032dlsp1ev9s5l94v2n.apps.googleusercontent.com",
  "googleClientSecret": "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",
  "googleRedirectUri": "http://localhost:3000/api/auth/callback/google",
  "lineClientSecret": "0b5130bcf2d330c98351070fcd5674d0"
};
const envOptions = {
  prefix: "NITRO_",
  ...
  if (query.code) {
    try {
      ...
      try {
        ...
        console.log("ID type:", typeof (existingUser == null ? void 0 : existingUser.id));
        if (existingUser) {
          const authData2 = {
            user: {
...
const google$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: google
});
